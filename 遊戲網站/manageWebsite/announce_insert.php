	...
	<body>
		<?php 
			if(isset($_SESSION['account']))
			{
				...
				<br/>
				<div class="container">
					<form name="reg" method="POST" action="announce_insert_finish.php">
					<table border="1" width="100%">
					<tr>
						<td colspan="2" bgcolor="#666666"> 
							<h2 align="center"><font color="#FFFFFF">新增公告</font></h2>
						</td>
					</tr>
					<tr bgcolor="#EEEEEE">
						<td><br/>屬性<br/><br/></td>
					...
					<tr>
						<td><br/>標題<br/><br/></td>
						<td>
							<br/><input type="text" class="form-control" placeholder="標題" name="title" style="width:50%"/><br/>
						</td>
					</tr>
					<tr bgcolor="#EEEEEE">
						<td><br/>超連結<br/><br/></td>
						<td>
							<br/><input type="text" class="form-control" placeholder="超連結" name="url" style="width:50%"/><br/>
						</td>
					</tr>
					<tr>
						<td><br/>上傳時間<br/><br/></td>
						<td>
							<br/><input type="text" id="datepicker" class="form-control" placeholder="上傳時間" name="update_date" style="width:50%"/>
						</td>
					</tr>
